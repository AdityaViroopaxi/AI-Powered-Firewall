...
def download_documentation_pdf():
    ...
    try:
        ...
        # Add title
        title = Paragraph("AI-Powered Firewall: Technical Documentation", title_style)
